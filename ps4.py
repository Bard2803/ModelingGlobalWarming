...
def generate_models(x, y, degs):
    ...
    modelList = []
    for deg in degs:
        modelList.append(np.polyfit(x, y, deg))
...
def r_squared(y, estimated):
    ...
    mean = sum((estimated-y)**2)/len(y)
    return 1 - mean/np.var(y)
